...
string trajectory_file = "/home/yangpeiwen/Documents/ypw/wcq_lab/build/egm.txt"; // 
// string trajectory_file = "/home/yang/works/demo_Laser_welding1/build/dataset/handeye_28/info/egm_data.txt";
...
int main(int argc, char **argv) 
{
  ...
  while (!fin.eof()) {
    ...
    // fin >> tx >> ty >> tz >> eularx >> eulary >> eularz;
    fin >> tx >> ty >> tz >> r1 >> r2 >> r3 >> r4 >> r5 >> r6 >> r7 >> r8 >> r9;
    std::cout << index << " " << tx << " " << ty << " " << tz << " " << r1 << std::endl;
    index++;
    Eigen::Matrix3d matlab_rot;
    matlab_rot << r1, r2, r3, r4, r5, r6, r7, r8, r9;
    Quaterniond q  = gtsam::Quaternion(matlab_rot);
    ...
    Twr.pretranslate(Vector3d(tx/100, ty/100, tz/100));// 设置平移向量
