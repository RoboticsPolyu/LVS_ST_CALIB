...
inline void update_val_robo_only2(int count, Robot* sysRobot1 = nullptr)
{
	double x_p, y_p = 0;
	float x_f = 0, y_f = 0, z_f = 0;
	float eular_x = 0, eular_y, eular_z;

	sysRobot1->GetFeedbackPose(x_f, y_f, z_f, eular_x, eular_y, eular_z);


	// if(count <= 500)
	// {
	// 	y_p = count / 1500.0 * 300;
	// 	sysRobot1->RobotPos[0] = 451;
	// 	sysRobot1->RobotPos[1] = y_p;
	// 	sysRobot1->RobotPos[2] = 807;
	// }
	// else
	// {
	// 	y_p = 500.0 / 1500.0 *300 - (count - 500)  / 1500.0 * 300;

	// 	sysRobot1->RobotPos[0] = 451;
	// 	sysRobot1->RobotPos[1] = y_p;
	// 	sysRobot1->RobotPos[2] = 807;
	// }
	// sysRobot1->RobotEuler[0] = 0;
	// sysRobot1->RobotEuler[1] = 180;
	// sysRobot1->RobotEuler[2] = 0;
	...
	// {
	// 	sysRobot1->RobotPosSpeed[0] = 0;
	// 	sysRobot1->RobotPosSpeed[1] = -vel;
	// 	sysRobot1->RobotPosSpeed[2] = 0;
	// 	y_p = vel* 0.004* 500 - vel* 0.004* (count - 500);
	// }
