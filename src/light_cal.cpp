...
namespace calibration
{
    ...
    {  
		...
		//creat test points
		Eigen::Vector3f a_1 (1308.3447, 597.87836, 0);
		Eigen::Vector3f b_1 (1384.4047, 670.59821, 0);
		Eigen::Vector3f c_1 (1467.2292, 748.35651, 0);
		Eigen::Vector3f p_1 (1434.3005, 717.15033 ,0);
		...
		cv::hconcat(output_data.rvecsMat, output_data.tvecsMat, temp_mat_1);
		cv::Mat M_cw_temp;
