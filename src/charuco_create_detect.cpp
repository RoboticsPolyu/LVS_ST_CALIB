...
void charuco_create_detect::createBoard()
{
...
void charuco_create_detect::detectCharucoBoardWithCalibrationPose()
{
...
void charuco_create_detect::detectCharucoBoardWithoutCalibration()
{
    cv::VideoCapture inputVideo;
    inputVideo.open(0);
    cv::Ptr<cv::aruco::Dictionary> dictionary = cv::aruco::getPredefinedDictionary(cv::aruco::DICT_6X6_250);
...
void charuco_create_detect::detectCharucoBoard(cv::Mat& image, std::vector<cv::Point2f>& charucoCorners, std::vector<int>& charucoIds)
{
    cv::Ptr<cv::aruco::Dictionary> dictionary = cv::aruco::getPredefinedDictionary(cv::aruco::DICT_4X4_1000);
    cv::Ptr<cv::aruco::CharucoBoard> board = cv::aruco::CharucoBoard::create(8, 11, 0.02f, 0.016f, dictionary);
    cv::Ptr<cv::aruco::DetectorParameters> params = cv::aruco::DetectorParameters::create();
    params->cornerRefinementMethod = cv::aruco::CORNER_REFINE_NONE;
